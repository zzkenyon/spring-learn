...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * Constant that indicates 不能自动注入.
	 * @see #setAutowireMode
	 */
	...
	/**
	 * Constant that indicates 无依赖检查
	 * @see #setDependencyCheck
	 */
	public static final int DEPENDENCY_CHECK_NONE = 0;

	/**
	 * Constant that indicates 对象引用的依赖检查
	 * @see #setDependencyCheck
	 */
	public static final int DEPENDENCY_CHECK_OBJECTS = 1;

	/**
	 * Constant that indicates "简单"属性的依赖检查
	 * @see #setDependencyCheck
	...
	/**
	 * Constant that indicates 所有属性的依赖检查
	...
	/**
	 * 容器应该尝试推断bean的销毁方法名，而不是显式地指定方法名。
	...
	/**
	 * 注解了@Primary的bean 会改成 true
	 */
	private boolean primary = false;

	/**
	 * 注解@Qualifiers("beanName") 会从该Map中取值
	 */
	private final Map<String, AutowireCandidateQualifier> qualifiers = new LinkedHashMap<>(0);

	/**
	 * 实例提供方 ，实例化bean的时候，如果这边设置了提供方会从提供方获取实例对象
	 */
	@Nullable
	...
	/**
	 * xml配置中可以显示指定
	 * 注解配置时，@Configuration注解的类将称为factoryBeanName,类中@Bean注解的方法，将成为factoryMethodName
	 */
	@Nullable
	...
	/**
	 * Override settings in this bean definition (可能是从父-子继承关系中复制的父) from the given bean
	 * definition (子).
	 * <ul>
