...
/**
 * A root bean definition 表示在运行时支持BeanFactory中特定bean的合并bean定义.
 * 它可能是由多个相互继承的原始bean定义创建的，
 * 通常程序注册的bd为GenericBeanDefinitions实例.
 * A root bean definition 本质上是运行时的“统一”bean定义视图.
 *
...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** Package-visible field for 缓存工厂方法返回值类型*/
	@Nullable
	...
	/** Package-visible field for caching 已解析的构造函数或工厂方法 */
	@Nullable
	Executable resolvedConstructorOrFactoryMethod;

	/** Package-visible field that marks 构造函数的参数是否已解析 */
	boolean constructorArgumentsResolved = false;

	/** Package-visible field for caching 全解析的构造参数 */
	@Nullable
